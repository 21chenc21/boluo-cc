...
DATA_VERSION="i164-sp29"  # 2026-06-25 sp29: 164-d (+B顺紧密度161-162 +C进范可行性163) + 成手奖励rank破平(顶kicker AAK>AAQ / 中底单对 QQ>JJ / 两对 22/TT>22/88) + 概率挑牌模型(cardsSeen, 行成手概率5.7%→48%). label+inDim 都变, fresh dataset.
